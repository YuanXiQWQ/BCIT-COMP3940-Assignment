...
"</html>"
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      if(uploadDate.equals("")) uploadDate = "2020-10-10";
 ...
 System.out.println(">>>>>" + question + uploadDate + fileName);
      ...
      try {
         con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:49732:XE", "system", "oracle1");
         PreparedStatement preparedStatement = con.prepareStatement("INSERT INTO trivias (ID,Question, ContentPath, Content) VALUES (?,?,?,?)");
